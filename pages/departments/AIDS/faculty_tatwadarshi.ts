...
const faculty: FacultyData = {
  ...
  books: [
    { title: "Cyber Security Threats and Challenges Facing Human Life", subtitle: "Edited Book · Chapman & Hall CRC Press, Taylor & Francis Group, UK · ISBN: 9781032111285 · e-ISBN: 9781003218555" },
    { title: "Intelligent Approaches to Cyber Security", subtitle: "Edited Book · Chapman & Hall CRC Press, Taylor & Francis Group, UK · ISBN: 9781032521619 (Scopus Indexed)" },
    { title: "Natural Language Processing – Sem VII, B.E. Computer Engineering, University of Mumbai", subtitle: "Authored Book · ISBN: 9789355830913" },
    { title: "Natural Language Processing – Sem VIII, B.E. Electronics & Telecommunication / Electronics & CS, University of Mumbai", subtitle: "Authored Book · ISBN: 9789389926798" },
    { title: "Natural Language Processing – Sem VIII, B.E. Computer Engineering, Savitribai Phule Pune University", subtitle: "Authored Book · ISBN: 9789389926781" },
  ...
  patents: [
    { title: "Patent 1 – Deep Learning / NLP / Data Security domain (details to be updated)" },
    { title: "Patent 2 – Deep Learning / NLP / Data Security domain (details to be updated)" },
