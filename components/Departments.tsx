...
const departments: Card[] = [
  {
    ...
    src: '/Images/Departments/Computer%20Engineering/InfrastructurecompsLAB-01.jpg',
    href: '/computer-engineering',
  },
  {
    title: 'Computer Science & Engineering (Data Science)',
    description: 'Data Science, AI & Applied Analytics',
    src: '/Images/Departments/MMS(MBA)/faciliteis/computerlabs-1.png',
    href: '/cs-data-science',
  },
  {
    title: 'Information Technology',
    description: 'Cloud, Security & Enterprise Computing',
    src: '/Images/Departments/Information%20Technology/infrastructureinftIT-LAB-12-scaled.jpg',
    href: '/information-technology',
  },
  {
    title: 'Artificial Intelligence & Data Science',
    description: 'Machine Learning & Intelligent Systems',
    src: '/Images/Departments/MMS(MBA)/faciliteis/computerlabs-2.png',
  ...
  },
  {
    ...
    src: '/Images/Departments/Electronics%20&%20Telecommunication/extc-infra-Basic-Electronics.png',
    href: '/electronics-telecomm',
  },
  {
    title: 'Civil Engineering',
    description: 'Infrastructure, Planning & Sustainability',
    src: '/Images/Departments/Civil%20Engineering/civi-infra-Building-Materials-Construction-Technology-Lab.png',
